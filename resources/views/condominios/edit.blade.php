                    ...
                    <div class="col-md-8">
                        ...
                        @if ($errors->any())
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>Erro ao atualizar condominio:</strong>
                                <ul class="mb-0">
                        ...
                        <form action="{{ route('condominios.update', $condominio->id_condominio) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                       ...
                                       id="cnpj"
                                       name="cnpj"
                                       value="{{ old('cnpj', $condominio->cnpj) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('pasta_gravacoes', $condominio->pasta_gravacoes) }}"
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox"
                                       ...
                                       name="ativo"
                                       value="1"
                                       {{ old('ativo', $condominio->ativo) ? 'checked' : '' }}>
